...
## Contents of this file {.unnumbered}
\
\

* **Figure S1:** Multimodel mean change in the frecuency of $\Delta T_{2.5}$ by seasons.
* **Figure S2:** Mean change in the mean $\Delta T_{2.5}$ frequency and $\partial \bar{T} / \partial y$ and EKE by seasons.
