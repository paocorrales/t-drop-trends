...
data <- purrr::map(c(Sys.glob(here("data/eke_mean/*hist*mean.nc")), Sys.glob(here("data/deltat/*hist*mean.nc"))), function(f) {
  ...
  file_scenario <- Sys.glob(here(paste0("data/", c("eke_mean", "deltat"), "/", meta[[1]][["var"]], "_", meta[[1]][["model"]], "_ssp585_mean.nc")))
...
tas <- purrr::map(Sys.glob(here("data/tas/*hist*.nc")), function(f) {
