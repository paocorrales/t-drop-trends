...
A similar relationship across the ensemble is present when comparing changes in the frequency of $\Delta T_{2.5}$ and changes in the energy of the storm track. Here we estimate the storm track energy by taking the band-pass filtered eddy kinetic energy at 250 hPa (see @sec-storm-track) and integrating over the 25$^{\circ}$ and 65$^{\circ}$ latitudes in each hemisphere. Models with projected decreases in EKE tend to project larger decreases in the frequency of $\Delta T_{2.5}$. 
