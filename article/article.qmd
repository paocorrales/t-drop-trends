---
title: "Future changes in cold front frequency in CMIP6 climate projections"
format:
    agu-pdf:
        keep-tex: true
    agu-html: default
...
Cold fronts are an important feature of weather in extratropical regions and are partly responsible for the precipitation in these areas [@Konstali2024]. Cold fronts are also linked to extreme events, such as heavy precipitation [@Catto2013] and severe wildfires in southern Australia [@Cai2022] and other regions. 
...
In the Southern Hemisphere over land, the change is generally positive with 5 more events per year in some areas. Other authors have also found an increase in the frequency of fronts in the south and east regions of Africa and Australia [@Catto2014; @Konstali2024]. @fig-trend a) and b) show over the southern oceans, a decrease in the frequency of $\Delta T$ between 30$^{\circ}$ and 45$^{\circ}$ S (depending on the longitude) and an increase to the south. This pattern indicates that the areas of higher front frequency shift poleward in the SSP5-8.5 experiment. This region is also associated with an increase in $\partial T/ \partial y$ and in storm track activity (not shown).
...
The mean time series of $\Delta T$ frequency for different latitude bands in @fig-serie shows trends consistent with @fig-trend a). Interestingly, the trend around 50$^{\circ}$ N in the Northern Hemisphere is negative over sea and land since the beginning of the 20$^{th}$ century. In the Southern Hemisphere over the oceans, the time series for 30$^{\circ}$ and 40$^{\circ}$ S latitude bands show a decrease in drops of temperature and the opposite happens on the 50$^{\circ}$ latitude band, indicating again a poleward shift of cold fronts in the future. It is important to note the variability between models in the subfigure next to each panel. Each box plot is calculated using the mean frequency of cold fronts between 2080 and 2100 for each model and region. The 50$^{\circ}$ latitude band in both hemispheres show the bigger changes but also the highest variability between models, however at least 90% of the models agree on the sign of the change.
...
```
To explore the distribution of the change in temperature drops of different intensity, @fig-distribution shows the change in frequency of $\Delta T$ using different percentiles, from 10 to 0.1$^{th}$, as thresholds to identify the drops in temperature. The percentile values are again calculated from the historical period between 1979 and 2014 for each grid point and model as in @fig-trend. This figure shows that the change in the frequency of $\Delta T$ is bigger at lower percentile thresholds, associated with more extreme temperature drops. For example in the Northern Hemisphere over sea, the 0.1 percentile threshold shows that there will be less than half drops in temperature in the future over 50$^{\circ}$ N, and the opposite is expected over land in the Southern Hemisphere. However, it is important to note that lower percentiles thresholds are associated to rarer events, meaning fewer occurrences per year. These results suggest that regions projected to experience more temperature drops in the future, such as land areas in midlatitudes in the Southern Hemisphere, will also experience more intense $\Delta T$, whereas regions with a decreasing frequency of events will see less intense drops in temperature.
...
@fig-eke explores the relationship between the change in the frequency of $\Delta T$ and the change in a) $\partial T / \partial y$ and b) EKE to the response to the increase of atmospheric $CO_2$ by comparing the scenario SSP5-8.5 (2080-2100) and the recent past (1980-2000). There is a positive relationship between the changes in $\Delta T$ and $\partial T / \partial y$ in both hemispheres. The reduction in the frequency of fronts in the Northern Hemisphere could be associated to the decrease of $\partial T / \partial y$ in low levels, result that has already been shown by other authors [e.g. @Catto2014]. The the opposite effect is present the Southern Hemisphere (@fig-eke a). 
We see a similar relationship between changes in $\Delta T$ and EKE indicating that the changes in the storm tracks can also affect the location and frequency of cold fronts. The exception is the Southern Hemisphere over land, the reason for this difference could be associated to many factors. 
...
In this study, we use day-to-day drops in near-surface maximum temperature as a method to detect cold fronts and to evaluate changes in their frequency under future warming, based on a set of 10 models from CMIP6. By using a specific percentile threshold, we ensure a consistent detection of strong temperature drops across different regions, improving sensitivity particularly over oceans where the temperature variability is lower. However, is important to note that by using the 2.5$^{th}$ percentiles, we may be filtering out week fronts and underestimating the overall frequency.  

Our results show a general decrease in front frequency across the Northern Hemisphere, especially over oceans, and a poleward shift in frontal activity in the Southern Hemisphere. Over land in the Southern Hemisphere, notably in regions like southern Australia and Africa, we find an increase in front frequency and intensity. These findings align with previous studies using more complex methods to identify fronts, strengthening confidence in our approach.

We find a positive correlation between changes in $\Delta T$ frequency and the meridional temperature gradient and transient eddy kinetic energy (EKE). This suggests that the causes for the projected changes are multifactorial and require a more in depth analysis. The expected correlation between front frequency and transient EKE is weaker over Southern Hemisphere land regions. This may reflect the fact that storm track dynamics have less direct control over frontal systems, which could be more influenced by mesoscale processes, land–sea contrast, and regional thermodynamic effects.

One important factor not analyzed here is the role of sea surface temperature (SST) gradients in frontal development. @Perfit2017 showed that the surface sensible heat flux can amplify a front, through diabatic frontogenesis  in regions with strong SST gradients, such as the Gulf Stream or Kuroshio Current. However, @Reeder2021 showed that atmospheric fronts along SST fronts are amplified primarily by adiabatic frontogenesis, i.e. the deformation of the wind field that help increase the equivalent potential temperature gradients. A projected weakening of SST gradients under climate change and in consequence, the sensible heat flux and wind circulation in the future could partially explain the changes in frequency of fronts along the west coast of North America and Asia. Further analysis is needed to quantify the contribution of these mechanisms to projected changes.
