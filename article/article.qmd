...
This approach offers several advantages. First, the method's simplicity and resolution-independence [as shown by @king2024] allows us to compare it with earlier studies using other methodologies. Second, focusing on local temperature falls provides a complementary perspective to Lagrangian approaches, as day-to-day temperature falls are the most direct impact of cold fronts on local weather.
...
change <- data |> 
  ...
  _[, let(region = fcase(lat %between% c(25, 55), "NH",
                         lat %between% c(-55, -25), "SH",
                         default = NA))] |> 
