...
#| fig-width: 8
#| fig-height: 5
#| fig.cap: "Multimodel mean frequency of $\\Delta T$ for the historical period (1850-2014) and SSP5-8.5 (2015-2100) over land and sea for different 2° wide latitude bands centered at 30, 40 and 50°. The grey line represents the climatological frecuency for 1979-2014, equal to 9.125 $\\Delta T_{2.5}$/year. On the right of each panel the intermodel distribution is shown for the period 2080-2100. In the boxplots the lower and upper hinges correspond to the first and third quartiles and the upper (lower) whisker extends to the largest (smallest) value no further than 1.5 * inter-quartile range. Outside the whiskers dots represents outliners."
...
#| fig-width: 8
#| fig-height: 5
#| fig.cap: "Fractional change in the frequency of strong $\\Delta T_{2.5}$ averaged between the years 2081-2100 under the SSP5-8.5 scenario compared to that averaged between 1980-2000 in the historical scenario, for different thresholds defined by their percentile value for each grid point and model calculated over the historical period (1979-2014)."
...
A similar relationship across the ensemble is present when comparing changes in the frequency of $\Delta T_{2.5}$ and changes in the energy of the storm track. Here we estimate the storm track energy by taking the eddy kinetic energy at 250 hPa and integrating over the 25$^{\circ}$ and 65$^{\circ}$ latitudes in each hemisphere. Models with projected decreases in EKE tend to project larger decreases in the frequency of $\Delta T_{2.5}$. 
The exception is the Southern Hemisphere over land where all models project weak changes in EKE and large increases in the frequency of $\Delta T_{2.5}$. The reason for this difference is unclear, but could suggest the importance of local land processes in amplifying fronts over land in some regions of the Southern Hemisphere (cite papers by Michael). Another hypothesis is that the most of the land affected by fronts in the Southern hemisphere is north of the mean storm tracks, and thus the storm tracks has only a weak effect on temperature variability there.
