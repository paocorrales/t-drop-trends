...
#| fig-width: 8
#| fig-height: 6
#| fig.cap: "Multimodel mean change in the frequency of $\\Delta T_{2.5}$ (days/year, SSP5-8.5 2018-2100 minus Historical 1980-2000) for a) DJF and b) JJA and $\\Delta T$ values associated to the 2.5 percentile calcualted for c) DJF and d) JJA. In a-b) dotted areas show where at least 90% of the models agree in the sign of change."
#| 
